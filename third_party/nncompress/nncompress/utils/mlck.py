...
def get_mlck_path():
    """ This function returns a special directory for nncompress.
...
def get_data_path():
    """ This function returns a special data directory for nncompress.
...
def get_saved_model_path():
    """ This function returns a special model directory for nncompress.
